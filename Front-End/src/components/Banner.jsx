...
//       <div
//         id="top"
//         className="bg-slate-950 text-gray-50 h-12 hidden sm:flex justify-around md:justify-center lg:justify-end  items-center top-0 z-10"
//       >
...
//           </marquee>
//         </div>
//         {/* "ShopNow" link hidden on mobile */}
//         <div className="flex text-center items-center justify-evenly pb-2">
//           <p className="font-semibold hover:underline hover:cursor-pointer hidden sm:block text-white text-xs">
//             ShopNow
//           </p>
//         </div>
//       </div>
